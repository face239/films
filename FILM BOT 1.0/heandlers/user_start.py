...
async def cmd_start(message: types.Message):
    if message.chat.type == types.ChatType.PRIVATE:
        try:
            ...
            await bot.send_message(chat_id=admin_id, text=f'*Новый пользователь* [{message.from_user.full_name}](tg://user?id={message.from_user.id})', parse_mode=types.ParseMode.MARKDOWN_V2)
        except:
            pass
        ...
        await message.answer(text=text_start, parse_mode=types.ParseMode.MARKDOWN_V2)
