...
try:
    data=['wellcome', '*Привет* [{full_name}](tg://user?id={user_id}) *ты в {username_bot} это самый лучший бот по фильмом веди код или название фильма и можешь даже посмотреть его бесплатно😉*']
